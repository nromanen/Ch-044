    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                goodmang.AddList(items, cont);


                //GoodManager goodmancsv = new GoodManager();
                //CategoryManager catmanagercsv = new CategoryManager();
                //ProducerManager prodmanagercsv = new ProducerManager();
                //var goodscsv = goodmancsv.ReadFromFile(GoodsPath);
                //var producerscsv = prodmanagercsv.ReadFromFile(ProducerPath);
                //var categorycsv = catmanagercsv.ReadFromFile(CategoryPath);
                //var full_a = Manager_FullGoods.Full_Goods(producerscsv, categorycsv, goodscsv);
                //manxml.WriteToFile(GoodsXmlPath, full_a);
