...
namespace WebApp.Controllers
{
    ...
    public class UniversalParserController : BaseController
    {
        ...
        public UniversalParserController(IDownloadManager downloadManager, ICategoryManager categoryManager, IWebShopManager shopManager, IParserTaskManager parsertaskManager, IURLManager urlManager, IExecuteManager taskinfoManager, IAppSettingsManager appSettingsManager)
        {
